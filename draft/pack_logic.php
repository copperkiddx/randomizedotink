...
function generateMultiplePacks(
    $numPacks,
    $cardsBySet,
    $cardRarity,
    $packSet,
    ...
    for ($i = 0; $i < $numPacks; $i++) {
        ...
        // Ensure we're dealing with a BoosterPack object
        if (is_object($boosterPack) && isset($boosterPack->cardsInBooster)) {
            // Merge the pack's cards into the allCards array
