...
<head>
	...
	<style>
		...
		/* Center-align the numbers within both dropdowns */
		select#player_count option, select#human_count option {
			text-align: center;
		}
...
<h2>Simulated Draft</h2>

<form action="draft_generation_results.php" method="post">
    <!-- Number of Humans -->
    <label for="human_count">Number of Humans</label><br><br>
    <select id="human_count" name="human_count" required>
    ...
    <!-- Number of Players -->
    <label for="player_count">Total Players</label><br><br>
